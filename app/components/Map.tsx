...
import marketShawdow from "leaflet/dist/images/marker-shadow.png";

// @ts-ignore because it is an opensource, typescript error showed
delete L.Icon.Default.prototype._getIconUrl;
L.Icon.Default.mergeOptions({
  iconUrl: marketIcon.src,
  iconRetinaUrl: marketIcon2x.src,
  shadowUrl: marketShawdow.src
